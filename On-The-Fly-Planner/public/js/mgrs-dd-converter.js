 ...
 * Hard-coded math implementation for DCS Planner.
 */

const MGRS_Lib = {

    /**
     * Converts Latitude/Longitude to MGRS String.
     * Returns format: "38T KM 12345 67890" (10-digit precision)
     */
    toMGRS: function (Lat, Long) {
    ...
    /**
     * Converts MGRS String to [Lat, Long] array.
     */
    toLatLon: function (a) {
        var b = a.trim();
        b = b.match(/\S+/g);
